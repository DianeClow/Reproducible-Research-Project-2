...
### Introduction
This analysis was produced for the second project in the Reproducible Research class offered on Coursera.  In this project, the Storm Datable maintained by NOAA was analysed looking for information on: 1) What events are most harmful to humans, and 2) What events have the greated economical impact.
...
These two are combined, only keeping the values that are present in both fatalities and injuries.  At this point there are 12 events that were both in the top 20 for both fatalities and injuries.  harm2 is the same as harm, but the data frame has been sorted by the number of Fatalities, with the largest value in the first row.
...
The event that has the largest economic impact is